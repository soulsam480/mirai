...
import { studentCertificationsAtom, useStudentUnverifiedSections, useUser } from '../../stores'
...
export function useCertification() {
  ...
  const setUnverifiedSections = useStudentUnverifiedSections('certifications')
